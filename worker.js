...
const BOT_TOKEN = "6505260119:AAGgnlJm_C8gQmNGaTETlYtKcrMWvc4EfnA"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "kyabaathai"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 1745041582; // Insert your telegram account id.
const BOT_CHANNEL = -1003514040604; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "kyabaathaibata"; // Insert a powerful secret text and keep it safe.
